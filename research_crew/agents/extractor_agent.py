...
def build_extractor_agent(llm: LLM) -> Agent:
    ...
    return Agent(
        ...
        goal=(
            ...
            "technical core: numeric metrics (accuracy, F1, latency, etc.), dataset names, "
            "methodology descriptions, and up to 2 verbatim quotes. "
            "Structure metrics clearly so they can be used in benchmark tables. "
            "Discard all boilerplate text. Return a JSON array with keys: "
